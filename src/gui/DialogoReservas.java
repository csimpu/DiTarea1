...
public class DialogoReservas extends javax.swing.JDialog {
    ...
    public DialogoReservas(java.awt.Frame parent, boolean modal) {
        ...
        jButtonConfirmar.setFont(BreezeSansRegular.deriveFont(12f));
        
        jLabelAlojamiento.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelApellidos.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelBoda.setFont(BreezeSansRegular.deriveFont(2, 12f));
        jLabelCapilla.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelCongreso.setFont(BreezeSansRegular.deriveFont(2, 12f));
        jLabelDatosCliente.setFont(BreezeSansBold.deriveFont(12f));
        jLabelDatosReserva.setFont(BreezeSansBold.deriveFont(12f));
        jLabelDni.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelFecha.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelNombre.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelNumAsistentes.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelNumDias.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelTelefono.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelTipoEvento.setFont(BreezeSansRegular.deriveFont(12f));
        jLabelTipoMenu.setFont(BreezeSansRegular.deriveFont(12f));
        
        jComboBoxTipoEvento.setFont(BreezeSansRegular.deriveFont(12f));
        jComboBoxTipoMenu.setFont(BreezeSansRegular.deriveFont(12f));
